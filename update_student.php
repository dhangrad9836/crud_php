...
$sex == null || $lunch_cost == false || $student_id == null){
  ...
  //query the database to UPDATE students table
$query = 'UPDATE students
          SET first_name = :first_name,
              ...
              sex = :sex,
              lunch_cost = :lunch_cost WHERE student_id = :student_id';
...
//     (:first_name, :last_name, :email, :street, :city, :state, :zip, :phone, :birth_date, :sex, :date_entered, :lunch_cost, :student_id)';
  ...
  //note that this below is from add_student.php where the Id is generated..above we are using the 
  //generated student id so no need for null, PDO::PARAM_INT as that is getting it from the database
 ...
 <html lang="en">
   ...
   <body>
     ...
     <form action="delete_student.php" method="post"
      ...
      <!--this below is from add_student.php we don't need this anymore-->
